      ...
      <div className="max-w-[1600px] mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 bg-slate-900/90 p-1 rounded-xl border border-slate-800">
          <button
            ...
            className={`flex items-center space-x-2 rounded-lg px-4 py-2 text-xs font-medium transition-all cursor-pointer ${
              activeTab === 'chat'
        ...
        <div className="flex items-center space-x-3">
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center space-x-2 rounded-xl bg-slate-900 border border-slate-800 px-3.5 py-2 text-xs cursor-pointer hover:border-slate-700 transition-all text-left"
            >
              ...
              <div className="absolute right-0 mt-2 w-64 rounded-xl border border-slate-800 bg-slate-900/95 p-2 shadow-2xl backdrop-blur-xl z-50">
                ...
                {Object.entries(PRESET_USERS).map(([key, user]) => (
                  <button
                    ...
                    className={`flex w-full items-center justify-between rounded-lg px-2.5 py-2 text-xs text-left transition-all cursor-pointer ${
                      currentPreset === key
